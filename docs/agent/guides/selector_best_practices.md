# E2E Locator Selection Guide

Tests live in the project root, UI source in your application's frontend code. Keep selectors semantic so Playwright BDD steps stay stable.
