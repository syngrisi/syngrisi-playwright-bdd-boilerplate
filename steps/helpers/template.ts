 ...
 */
export function renderTemplateObject<T extends Record<string, any>>(obj: T, testData: TestStore): T {
  const result: any = {};
 ...
 */
export function renderTemplateArray(arr: readonly string[], testData: TestStore): string[] {
